...
import { faEnvelope, faBriefcase, faHouse } from '@fortawesome/free-solid-svg-icons';
import { faSquareGithub } from '@fortawesome/free-brands-svg-icons';

const Header = () => {
    return (
        <div className="w-full backdrop-blur-sm h-16 fixed right-0 top-0 z-10 flex items-center justify-between">
            <div className="ml-[2%] text-gray-400 font-bold justify-self-start width-fit text-nowrap"><a href="/"><FontAwesomeIcon icon={faHouse} size="xl" className="text-[#E88D67] hover:opacity-80 duration-200 cursor-pointer" /></a></div>
