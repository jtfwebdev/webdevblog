...
const Hero = ({title, activeBlogTags}) => {
    return ( 
        <section className="h-[50vh] bg-[#CDEAFC] relative">
            <div className="absolute pl-24 pb-8 top-[30%] font-poppins w-[80%]">
                {activeBlogTags &&
                    <div className="flex">
                ...
                {!title ? <>
                    <h3 className="text-xl text-[#25283D]">Welcome to my</h3>
                    <h1 className="text-6xl text-[#25283D] font-bold">Web Development Blog</h1>
                </> : <>
            ...
            <div className="custom-shape-divider-bottom-1707434871">
